...
const createImgTexture = function(gl, width, height, image, texNumber = 0){
...
const GLH = {
    createGL, createProgram, initFBO, initABO, createDataTexture, FeedbackABO, akABO, createImgTexture
};
export {createGL, createProgram, initFBO, initABO, createDataTexture, FeedbackABO, akABO, GLH};